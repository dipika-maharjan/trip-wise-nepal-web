import CreateRoomTypeForm from "../_components/CreateRoomTypeForm";

export default function CreateRoomTypePage() {
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                <a className="text-[#0c7272] hover:text-[#0a5555]" href="/admin/room-types">
                ...
                <h1 className="text-2xl font-bold text-gray-800">Create Room Type</h1>
            </div>
            <p className="text-gray-600 mt-2">Add a new room type to an accommodation</p>
